...
<table width="900" cellpadding="0" cellspacing="0"
       style="max-width:900px;background:#1a1a2e;border-radius:12px;
  ...
  <tr>
    <td style="padding:12px 32px;background:#12122a;border-top:1px solid #2a2a4a;">
      <div style="color:#666;font-size:11px;line-height:1.8;">
        ...
        Bayesiano Beta-Binomiale con Laplace smoothing.
  ...
  <tr>
    <td style="padding:16px 32px;text-align:center;">
      <div style="color:#444;font-size:11px;">
        Generato automaticamente da Streak Monitor — Kriterion Quant
        <br>
